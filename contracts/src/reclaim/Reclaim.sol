...
contract Reclaim {
    ...
    function fetchWitnessesForClaim(
        ...
        Witness[] memory selectedWitnesses =
            new Witness[](epochData.minimumWitnessesForClaimCreation);
    ...
    function verifyProof(Proof memory proof) public view {
        ...
        Claims.SignedClaim memory signed =
            Claims.SignedClaim(proof.signedClaim.claim, proof.signedClaim.signatures);
